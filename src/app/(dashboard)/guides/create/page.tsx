...
export default function CreateGuidePage() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    if (type === 'checkbox') {
      ...
      setFormData(prev => ({ 
        ...
        ...(name === 'title' && !formData.slug ? { slug: value.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)+/g, '') } : {})
      }));
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.title || !formData.slug || !formData.image || !formData.content) {
      toast.error('Please fill in all required fields (Title, Slug, Image URL, Content)');
      return;
    }
    ...
    try {
      ...
      toast.error(err?.response?.data?.message || 'Failed to create guide');
    } finally {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">Publish a new fitness or nutrition article</p>
          </div>
        </div>
        <button
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. 5 Daily Habits for a Healthier Stronger You"
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.slug}
                  onChange={handleChange}
                  placeholder="e.g. 5-daily-habits"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-300 px-4 py-2 focus:border-gold-500 focus:ring-gold-500 outline-none"
                />
                <p className="text-xs text-gray-500 mt-1">Paste a video link to embed it at the top of the article.</p>
              </div>
