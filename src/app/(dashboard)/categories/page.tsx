  ...
  return (
    <div className="animate-in fade-in duration-500">
      ...
      <div className="mt-4 rounded-2xl glass-panel shadow-luxury p-8 flex flex-col justify-center items-center h-96 border border-gray-200/50">
        ...
        <h3 className="text-lg font-bold text-gray-900 mb-2">Categories List</h3>
        <p className="text-gray-500 font-medium text-center max-w-sm">Category management will be implemented here soon.</p>
      </div>
    </div>
  );
}
